                ...
                <table border="1px" cellspacing="0" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                <a href="edit-kategori.php?id=<?php echo $row['category_id'] ?>"> <img src="img/edit6.png" height="35px" width="35px"></a>   <a href="proses-hapus.php?idk=<?php echo $row['category_id'] ?>" onclick="return confirm('Yakin mau hapus ?')"><img src="img/delete5.png" width="35px" height="35px"></a>
                                </center>
                            </td>
                        </tr>
                        <?php }}else{ ?>
