...
<body>
    ...
    <header>
    <div class="container">
    <h1><a href="dashboard.php"> &#8226 <span>B</span>akoel <span>B</span>oekoe</a></h1>
        <ul>
                ...
                <table border="1" cellspacing="0" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                <a href="edit-produk.php?id=<?php echo $row['product_id'] ?>"><img src="img/edit6.png" height="35px" width="35px"></a> <a href="proses-hapus.php?idp=<?php echo $row['product_id'] ?>" onclick="return confirm('Yakin mau hapus ?')"><img src="img/delete5.png" width="35px" height="35px"></a>
                                </center>
                            </td>
                        </tr>
                        <?php }}else{ ?>
